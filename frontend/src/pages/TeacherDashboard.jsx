...
export default function TeacherDashboard() {
  ...
  return (
    <div className="shell">
      <Sidebar items={ITEMS} footer="Cohort analytics are computed by running the trained models over every stored student." />
      <div>
        <Navbar title="Teacher dashboard" subtitle="Cohort monitoring and intervention triage" />
